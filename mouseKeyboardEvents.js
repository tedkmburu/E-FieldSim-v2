function moveKeys() // inbuilt p5 function. if the arrow keys are pressed, the selected charge moves
{
...
function mouseDragged()
{
  ...
  //     if (snapToGrid)
  //     {
  //       chargeDragged.position.x = constrain(roundToNearestGrid(mouseX), 0, width - sidePanelWidth);
